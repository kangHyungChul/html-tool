...
HTML 콘텐츠가 `{셀주소}` placeholder로 치환된 항목만 정리한 리포트입니다.
...
| 14 | D15 | text | span.cmp-button__text.c-button__text | Commercial ERV | {D15} | |
...
| 58 | E41 | text | span.cmp-button__text.c-button__text | LG BaseWare | {E41} | |
...
| 101 | D13 | attribute:alt | img[alt] | Single Packaged | {D13} | |
| 102 | D14 | attribute:alt | img[alt] | Single Split | {D14} | |
| 103 | D15 | attribute:alt | img[alt] | Commercial ERV | {D15} | |
| 104 | D16 | attribute:alt | img[alt] | Air to Water Heat Pump | {D16} | |
| 105 | D16 | attribute:alt | img[alt] | Air to Water Heat Pump | {D16} | |
| 106 | D21 | attribute:alt | img[alt] | Multi Split | {D21} | |
| 107 | D22 | attribute:alt | img[alt] | Residential ERV | {D22} | |
| 108 | D23 | attribute:alt | img[alt] | Water Heater | {D23} | |
| 109 | D27 | attribute:alt | img[alt] | Chiller | {D27} | |
| 110 | D28 | attribute:alt | img[alt] | Data Center Solutions | {D28} | |
| 111 | E12 | attribute:alt | img[alt] | Cockpit Domain Controller | {E12} | |
| 112 | E13 | attribute:alt | img[alt] | High Performance Computing | {E13} | |
| 113 | E21 | attribute:alt | img[alt] | Transformative & Dynamic | {E21} | |
| 114 | E22 | attribute:alt | img[alt] | Connected & Productive | {E22} | |
| 115 | E27 | attribute:alt | img[alt] | Standalone type TCU | {E27} | |
| 116 | E28 | attribute:alt | img[alt] | Integrated-antenna type TCU | {E28} | |
| 117 | E33 | attribute:alt | img[alt] | Driving solution | {E33} | |
| 118 | E34 | attribute:alt | img[alt] | In-cabin solution | {E34} | |
| 119 | E38 | attribute:alt | img[alt] | LG PlayWare | {E38} | |
| 120 | E39 | attribute:alt | img[alt] | LG MetaWare | {E39} | |
| 121 | E40 | attribute:alt | img[alt] | LG VisionWare | {E40} | |
| 122 | E41 | attribute:alt | img[alt] | LG BaseWare | {E41} | |
| 123 | E42 | attribute:alt | img[alt] | LG OpsWare | {E42} | |
| 124 | F12 | attribute:alt | img[alt] | LED Signage | {F12} | |
| 125 | F13 | attribute:alt | img[alt] | Digital Signage | {F13} | |
| 126 | F14 | attribute:alt | img[alt] | Commercial TV | {F14} | |
| 127 | F15 | attribute:alt | img[alt] | Software Solutions | {F15} | |
| 128 | F20 | attribute:alt | img[alt] | Monitors | {F20} | |
| 129 | F21 | attribute:alt | img[alt] | PCs | {F21} | |
| 130 | F22 | attribute:alt | img[alt] | Medical Displays | {F22} | |
| 131 | F23 | attribute:alt | img[alt] | Projectors | {F23} | |
| 132 | G20 | attribute:alt | img[alt] | Antimicrobial Additive: PuroTec™ | {G20} | |
| 133 | G21 | attribute:alt | img[alt] | Washing Material: Mineral Wash | {G21} | |
| 134 | G22 | attribute:alt | img[alt] | Marine Restoration Material | {G22} | |
| 135 | G27 | attribute:alt | img[alt] | Compressors | {G27} | |
| 136 | G28 | attribute:alt | img[alt] | Motors | {G28} | |
| 137 | G29 | attribute:alt | img[alt] | Robot Actuator | {G29} | |
| 138 | G33 | attribute:alt | img[alt] | Washer | {G33} | |
| 139 | G34 | attribute:alt | img[alt] | Dryer | {G34} | |
...
- Cell: F4
- Type: text
- HTML Context: a#tab-media-entertainment-solution.c-tabs__item.font-m-normal-16.font-w-normal-20
...
- Cell: D6
- Type: text
- HTML Context: h2.cmp-title__text

```diff
- Life’s Good with air comfort beyond imagination
+ {D6}
```
...
- Cell: D9
- Type: text
- HTML Context: h3.accordion-button-text
...
- Cell: D12
- Type: text
- HTML Context: span.cmp-button__text.c-button__text
...
```diff
- Life’s Good with intelligence in every drive
+ {E6}
```
...
```diff
- Life’s Good with solutions beyond displays
+ {F6}
```
...
```diff
- Life’s Good with leading solutions built from inside
+ {G6}
```
